$(function() { //调用插件
    ...
    var shibiao;
	/*$.fn.citySelect();*/
	var sheng_cj = dsy.Items["0"];
	var li = "";
	for(var i = 0; i < sheng_cj.length; i++) {
		li += "<li><a>" + sheng_cj[i] + "</a></li>";
	}
	$(".num1").html(li);
	sheng_click();
});
function sheng_click(){
	var sheng_li = $('.num1 li');
	
	for(var i = 0; i < sheng_li.length; i++) {
		sheng_li[i].index = i;
		sheng_li[i].onclick = function() {
			this.parentElement.style.display = 'none';
			$(".num1 li a").css("color","#A3A3A3");
			$(this)[0].getElementsByTagName("a")[0].style.color="rgb(247, 71, 30)";
			var sheng_name = this.getElementsByTagName("a")[0].innerHTML;
			$("#Province i").html(sheng_name);
			$("#City i").html("请选择城市");
			$("#Area i").html("请选择地区");
		    xiabiao = "0_" + this.index;
			var shi_cj = dsy.Items[xiabiao];
			var li = "";
			for(var i = 0; i < shi_cj.length; i++) {
				li += "<li><a>" + shi_cj[i] + "</a></li>";
			}
			$(".num2").html(li);
			$(".mo_ssq i").css("border-bottom-color","#FFFFFF");
			$(".mo_ssq i").css("color","#000000");
			$("#City i").css("color","#F7471E");
			$("#City i").css("border-bottom-color","#F7471E")
...
function shi_click(){
	...
	for(var i = 0; i < shi_li.length; i++) {
		shi_li[i].index = i;
		shi_li[i].onclick = function() {
			$(".num2 li a").css("color","#A3A3A3");
			$(this)[0].getElementsByTagName("a")[0].style.color="rgb(247, 71, 30)";
			this.parentElement.style.display = 'none';
			var shi_name = this.getElementsByTagName("a")[0].innerHTML;
			$("#City i").html(shi_name);
			$("#Area i").html("请选择地区");
			 shi_biao =xiabiao+"_" + this.index;
			var qu_cj = dsy.Items[shi_biao];
			var li = "";
			for(var i = 0; i < qu_cj.length; i++) {
				li += "<li><a>" + qu_cj[i] + "</a></li>";
			}
			$(".num3").html(li);
			$(".mo_ssq i").css("border-bottom-color","#FFFFFF");
			$(".mo_ssq i").css("color","#000000");
			$("#Area i").css("color","#F7471E");
			$("#Area i").css("border-bottom-color","#F7471E")
...
function qu_click(){
	...
	for(var i = 0; i < qu_li.length; i++) {
		qu_li[i].index = i;
		qu_li[i].onclick = function() {
			$(".num3 li a").css("color","#A3A3A3");
			$(this)[0].getElementsByTagName("a")[0].style.color="rgb(247, 71, 30)";
			var qu_name = this.getElementsByTagName("a")[0].innerHTML;
			$("#Area i").html(qu_name);
			$('.mo').click();
