...
(function (factory) {
    ...
    $('#d-confirm').bind('click',function(){
        ...
        createDate.toNow(true);
        /*修改日期*/
         $(".select_time")[qjbl].innerHTML=$(".piao")[qjbl].getElementsByClassName("riqi")[0].value;
    })
}))